...
"}")
        ...
        self.inp_lag_sysid_in.setObjectName(u"inp_lag_sysid_in")
        ...
        self.extended_lsq_radio_group.setObjectName(u"extended_lsq_radio_group")
        self.extended_lsq_radio_group.addButton(self.true_ext_lsq)
        self.true_ext_lsq.setObjectName(u"true_ext_lsq")
        self.true_ext_lsq.setChecked(True)

        self.gridLayout_15.addWidget(self.true_ext_lsq, 1, 0, 1, 1, Qt.AlignmentFlag.AlignLeft)

        self.false_ext_lsq = QRadioButton(self.widget_18)
        self.extended_lsq_radio_group.addButton(self.false_ext_lsq)
        self.false_ext_lsq.setObjectName(u"false_ext_lsq")
        ...
        self.esti_sysid_in.setObjectName(u"esti_sysid_in")
    ...
    def retranslateUi(self, Arduino_GetModel_W):
        ...
        self.false_ext_lsq.setText(QCoreApplication.translate("Arduino_GetModel_W", u"False", None))
