...
################################################################################
## Form generated from reading UI file 'PyDAQ_BaseHDaLzy.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_9.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_11.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QRect(0, 0, 610, 418))
        ...
        self.menuBenchmarking_2 = QMenu(self.menuMenu)
        self.menuBenchmarking_2.setObjectName(u"menuBenchmarking_2")
        ...
        self.menuMenu.addAction(self.menuBenchmarking_2.menuAction())
        self.menuMenu.addAction(self.actionAbout)
        self.menuBenchmarking_2.addAction(self.actionArduino_2)
        self.menuBenchmarking_2.addAction(self.actionNIDAQ_2)
    ...
    def retranslateUi(self, PydaqGlobal):
        ...
        self.menuBenchmarking_2.setTitle(QCoreApplication.translate("PydaqGlobal", u"Benchmarking", None))
    # retranslateUi
