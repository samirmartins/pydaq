...
################################################################################
## Form generated from reading UI file 'PyDAQ_step_response_NIDAQ_widget.ui'
##
...
"}")
        ...
        self.gridLayout.addWidget(self.line, 0, 1, 14, 1)
        ...
        self.gridLayout.addWidget(self.widget_14, 7, 2, 1, 1)
        ...
        self.yes_pid_radio = QRadioButton(self.widget_16)
        self.pid_radio_group = QButtonGroup(NIDAQ_StepResponse_W)
        self.pid_radio_group.setObjectName(u"pid_radio_group")
        self.pid_radio_group.addButton(self.yes_pid_radio)
        self.yes_pid_radio.setObjectName(u"yes_pid_radio")

        self.horizontalLayout_4.addWidget(self.yes_pid_radio)

        self.no_pid_radio = QRadioButton(self.widget_16)
        self.pid_radio_group.addButton(self.no_pid_radio)
        self.no_pid_radio.setObjectName(u"no_pid_radio")
        self.no_pid_radio.setMinimumSize(QSize(60, 0))
        self.no_pid_radio.setChecked(True)

        self.horizontalLayout_4.addWidget(self.no_pid_radio)

        self.PID_comboBox = QComboBox(self.widget_16)
        ...
        self.horizontalLayout_4.addWidget(self.PID_comboBox)


        self.gridLayout.addWidget(self.widget_16, 10, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
        ...
        self.PID_comboBox.setCurrentIndex(2)
    ...
    def retranslateUi(self, NIDAQ_StepResponse_W):
        ...
        self.PID_comboBox.setCurrentText(QCoreApplication.translate("NIDAQ_StepResponse_W", u"PID", None))
