...
class Ui_NIDAQ_SendData_W(object):
    def setupUi(self, NIDAQ_SendData_W):
        if not NIDAQ_SendData_W.objectName():
            NIDAQ_SendData_W.setObjectName("NIDAQ_SendData_W")
        NIDAQ_SendData_W.resize(527, 379)
        NIDAQ_SendData_W.setStyleSheet(
        ...
        self.out_range_min_in.setObjectName("out_range_min_in")
        ...
        self.out_range_max_in.setObjectName("out_range_max_in")
    ...
    def retranslateUi(self, NIDAQ_SendData_W):
        NIDAQ_SendData_W.setWindowTitle(
            QCoreApplication.translate("NIDAQ_SendData_W", "Form", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Choose channel:", None)
        )
        self.yes_plot_radio.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Yes", None)
        )
        self.no_plot_radio.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "No", None)
        )
        self.path_folder_browse.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", " Browse ", None)
        )
        self.label.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Choose device:", None)
        )
        self.label_8.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Data path", None)
        )
        self.label_4.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Sample period (s)", None)
        )
        self.label_6.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Plot data?", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Output range (V)", None)
        )
        self.label_5.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Minimum", None)
        )
        self.label_7.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "Maximum", None)
        )
        self.start_send_data.setText(
            QCoreApplication.translate("NIDAQ_SendData_W", "SEND DATA", None)
        )
